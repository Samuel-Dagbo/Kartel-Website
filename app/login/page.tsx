        ...
        >
          ...
          <div className={`relative rounded-2xl p-5 ${
            ...
            <form onSubmit={handleSubmit} className="space-y-3">
              ...
              <button type="submit" disabled={loading} className="w-full mt-1 py-2.5 bg-gradient-to-r from-kartel-gold to-kartel-gold-light text-kartel-black font-semibold text-sm rounded-lg shadow-gold-glow hover:shadow-gold-glow-lg transition-all duration-500 disabled:opacity-50 flex items-center justify-center gap-2">
