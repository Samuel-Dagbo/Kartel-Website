          ...
          <div className="absolute bottom-8 left-8 right-8 z-10">
            ...
            >
              <div className="flex items-center gap-2 mb-3">
                ...
                <span className="text-[10px] font-semibold tracking-[0.2em] uppercase text-kartel-gold">Member Exclusive</span>
              </div>
              <h2 className="font-serif text-xl font-bold text-white leading-tight mb-2">
                Welcome to the <span className="text-gradient">Inner Circle</span>
              </h2>
              <p className="text-xs text-white/40 leading-relaxed">
                Access exclusive collections, early releases, and personalized fragrance recommendations.
              </p>
            </motion.div>
          </div>
        </div>
        ...
        >
          ...
          <div className={`relative rounded-2xl p-5 ${
            ...
            <form onSubmit={handleSubmit} className="space-y-3">
              ...
              <div className="space-y-1">
                <div className="flex items-center justify-between">
                  ...
                  <Link href="/forgot-password" className={`text-[10px] transition-colors ${
                    isDark ? 'text-kartel-gold/60 hover:text-kartel-gold' : 'text-kartel-gold/70 hover:text-kartel-gold'
                  }`}>Forgot?</Link>
                </div>
                <div className="relative group">
              ...
              <button type="submit" disabled={loading} className="w-full mt-1 py-2.5 bg-kartel-black text-white font-semibold text-sm rounded-lg shadow-lg hover:bg-kartel-black-900 transition-all duration-500 disabled:opacity-50 flex items-center justify-center gap-2">
