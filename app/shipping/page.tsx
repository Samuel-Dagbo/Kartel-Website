      ...
      <main className="pt-32 pb-20">
        <div className="container-luxury">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-5xl mx-auto mb-16">
            ...
            >
              <h2 className="font-serif text-xl font-semibold text-heading mb-6 flex items-center gap-3">
              ...
              <div className="space-y-6">
                {[
                  ...
                  <div key={i} className="flex items-start gap-4 p-4 rounded-xl glass">
                    ...
                    <div>
                      <h3 className="text-heading font-medium">{option.name}</h3>
                      <p className="text-muted text-sm mt-1">{option.time}</p>
              ...
              <div className="space-y-4 text-body">
                ...
                <ul className="space-y-3">
                  <li className="flex items-start gap-3">
                    ...
                    <span><strong className="text-heading">30-day returns</strong> for unopened items in original condition</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="w-1.5 h-1.5 rounded-full bg-kartel-gold mt-2 shrink-0" />
                    <span><strong className="text-heading">Free return shipping</strong> on all continental US orders</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="w-1.5 h-1.5 rounded-full bg-kartel-gold mt-2 shrink-0" />
                    <span><strong className="text-heading">Instant refunds</strong> processed upon receipt of returned items</span>
                  </li>
                </ul>
                <p className="text-sm text-muted mt-4">Sale items are final sale and cannot be returned.</p>
              </div>
            </motion.div>
          </div>
          ...
          <motion.div
            ...
            className="p-8 glass-card max-w-5xl mx-auto"
          >
            <h2 className="font-serif text-xl font-semibold text-heading mb-6">International Shipping</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <p className="text-body mb-4">We ship to over 50 countries worldwide. International orders typically arrive within 7-14 business days.</p>
